      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-4 text-sm sm:text-base">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="mailto:contact@iamdurgesh.me"
                  className="hover:text-cyan-400 transition-colors duration-300"
                >
                  contact@iamdurgesh.me
                </a>
              </div>
          ...
          <form
            ...
            } relative overflow-hidden rounded-2xl border border-white/10 bg-white/3 p-5 sm:p-6 backdrop-blur-xl dark:border-black/10 dark:bg-black/3`}
          >
            <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-cyan-400 via-purple-500 to-pink-500"></div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-white/4 px-3.5 py-2.5 text-sm text-white placeholder:text-gray-500 outline-none transition-all duration-300 focus:border-cyan-400/70 focus:ring-2 focus:ring-cyan-400/10 dark:border-black/10 dark:bg-black/3 dark:text-black dark:placeholder:text-gray-400 dark:focus:border-cyan-600/60"
              />
            </div>
            ...
            <div className="space-y-1.5 mt-4">
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-white/10 bg-white/4 px-3.5 py-2.5 text-sm text-white placeholder:text-gray-500 outline-none resize-none transition-all duration-300 focus:border-cyan-400/70 focus:ring-2 focus:ring-cyan-400/10 dark:border-black/10 dark:bg-black/3 dark:text-black dark:placeholder:text-gray-400 dark:focus:border-cyan-600/60"
              ></textarea>
            </div>

            <button
              type="submit"
              className="group w-full mt-5 rounded-lg bg-linear-to-r from-cyan-400 via-purple-500 to-pink-500 px-5 py-2.5 text-sm font-semibold text-black transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(139,92,246,0.25)] active:translate-y-0"
            >
